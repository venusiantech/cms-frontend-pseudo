...
function DotGrid() {
  return (
    <div className="pointer-events-none fixed inset-0 z-0">
      ...
      />
      {/* Glows */}
      <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-[rgb(218,255,1)]/5 rounded-full blur-[200px]" />
      <div className="absolute bottom-1/4 right-0 w-[400px] h-[400px] bg-emerald-500/5 rounded-full blur-[150px]" />
    </div>
  );
}
